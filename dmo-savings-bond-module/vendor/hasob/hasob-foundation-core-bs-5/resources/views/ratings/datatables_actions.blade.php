{{--    
    <a href="#" data-val='{{$id}}' class='btn-show-mdl-rating-modal'>
        {!! Form::button('<i class="fa fa-eye"></i>', ['type'=>'button']) !!}
    </a>
    
    <a href="#" data-val='{{$id}}' class='btn-edit-mdl-rating-modal'>
        {!! Form::button('<i class="fa fa-edit"></i>', ['type'=>'button']) !!}
    </a>
    
    <a href="#" data-val='{{$id}}' class='btn-delete-mdl-rating-modal'>
...
<div class='btn-group' role="group">
    <a data-toggle="tooltip" 
        title="View" 
        data-val='{{$id}}' 
        class="btn-show-mdl-rating-modal" href="#">
    ...
    <a data-toggle="tooltip" 
        title="Edit" 
        data-val='{{$id}}' 
        class="btn-edit-mdl-rating-modal" href="#">
    ...
    <a data-toggle="tooltip" 
        title="Delete" 
        data-val='{{$id}}' 
        class="btn-delete-mdl-rating-modal" href="#">
