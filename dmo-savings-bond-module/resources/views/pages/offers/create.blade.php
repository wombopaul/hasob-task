    ...
    <div class="card border-top border-0 border-4 border-primary">
        <div class="card-body p-4">
            <div class="card-title d-flex align-items-center">
                ...
                <h5 class="mb-0 text-primary">Offer Details</h5>
            </div>
            <hr />
            {!! Form::open(['route' => 'sb.offers.store','class'=>'form-horizontal']) !!}
                ...
                <div class="col-lg-offset-3 col-lg-9">
                    ...
                    <a href="{{ route('sb.offers.index') }}" class="btn btn-default btn-warning">Cancel</a>
                </div>
