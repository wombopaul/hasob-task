...
<table class="table table-borderless">
    <tr>
        <th scope="row"> {!! Form::label('status', 'Status:', ['class'=>'control-label']) !!} </th>
        <td class="text-left">
    ...
    <tr>
        <th scope="row"> {!! Form::label('offer_title', 'Offer Title:', ['class'=>'control-label']) !!}  </th>
        <td class="text-left">
    ...
    <tr>
        <th scope="row"> {!! Form::label('price_per_unit', 'Price Per Unit:', ['class'=>'control-label']) !!}  </th>
        <td class="text-left">
    ...
    <tr>
        <th scope="row"> {!! Form::label('max_units_per_investor', 'Max Units Per Investor:', ['class'=>'control-label']) !!}   </th>
        <td class="text-left">
    ...
    <tr>
        <th scope="row">  {!! Form::label('interest_rate_pct', 'Interest Rate Pct:', ['class'=>'control-label']) !!}    </th>
        <td class="text-left">
    ...
    <tr>
        <th scope="row">   {!! Form::label('offer_start_date', 'Offer Start Date:', ['class'=>'control-label']) !!}     </th>
        <td class="text-left">
            <span id="spn_offer_offer_start_date">
                @if (isset($offer->offer_start_date) && empty($offer->offer_start_date)==false)
                    {!! date('d-M-Y', strtotime($offer->offer_start_date)) !!}
                @else
                    N/A
                @endif
                </span>
    ...
    <tr>
        <th scope="row">     {!! Form::label('offer_end_date', 'Offer End Date:', ['class'=>'control-label']) !!}      </th>
        <td class="text-left">
            <span id="spn_offer_offer_end_date">
                @if (isset($offer->offer_end_date) && empty($offer->offer_end_date)==false)
                    {!! date('d-M-Y', strtotime($offer->offer_end_date)) !!}
                @else
                    N/A
                @endif
                </span>
    ...
    <tr>
        <th scope="row">     {!! Form::label('offer_settlement_date', 'Offer Settlement Date:', ['class'=>'control-label']) !!}     </th>
        <td class="text-left">
            <span id="spn_offer_offer_settlement_date">
                @if (isset($offer->offer_settlement_date) && empty($offer->offer_settlement_date)==false)
                    {!! date('d-M-Y', strtotime($offer->offer_settlement_date)) !!}
                @else
                    N/A
                @endif
                </span>
    ...
    <tr>
        <th scope="row">      {!! Form::label('offer_maturity_date', 'Offer Maturity Date:', ['class'=>'control-label']) !!}      </th>
        <td class="text-left">
            <span id="spn_offer_offer_maturity_date">
                @if (isset($offer->offer_maturity_date) && empty($offer->offer_maturity_date)==false)
                    {!! date('d-M-Y', strtotime($offer->offer_maturity_date)) !!}
                @else
                    N/A
                @endif
                </span>
    ...
    <tr>
        <th scope="row">     {!! Form::label('tenor_years', 'Tenor Years:', ['class'=>'control-label']) !!}       </th>
        <td class="text-left">
